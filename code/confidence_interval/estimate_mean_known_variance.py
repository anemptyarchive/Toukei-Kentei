...
# 臨界値を計算
z_critical = norm.ppf(q=1.0-0.5*alpha, loc=0.0, scale=1.0)
...
def update(i):
    ...
    # ラベルを作成
    pop_param_lbl = f'$n = {n}, \\mu = {mu_pop:.2f}, \\sigma = {sigma_pop:.2f}$'
...
def update(I):
    ...
    # ラベルを作成
    pop_param_lbl = f'$Iteration = {I}, n = {N}, \\mu = {mu_pop:.2f}, \\sigma = {sigma_pop:.2f}$'
    ...
    # ラベルを作成
    smp_param_lbl = f'$\\bar{{x}}_i = {x_bar:.2f}$'
